...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <section className="relative py-20 px-6 bg-gradient-to-b from-transparent to-gray-50/50 z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="notion-card p-8 hover-lift fade-in fade-in-delay-1 group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Gravitational UX</h3>
            ...
            <div className="notion-card p-8 hover-lift fade-in fade-in-delay-2 group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Momentum & Flow</h3>
              <p className="notion-text leading-relaxed">
            ...
            <div className="notion-card p-8 hover-lift fade-in fade-in-delay-3 group">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Equilibrium Design</h3>
              <p className="notion-text leading-relaxed">
