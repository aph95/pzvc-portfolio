    ...
    <div className="space-y-12">
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Concept</h3>
        </div>
        <div className="space-y-4">
          <p className="text-foreground/80 leading-relaxed">
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Target group</h3>
        </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Technology scouting</h3>
        </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Early structure & flow</h3>
        </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">User journey mapping</h3>
        </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Storyboard</h3>
        </div>
        <p className="text-foreground/80 mb-6">
      ...
      <section>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-bold text-foreground mb-3">Prototype development</h3>
        </div>
