...
const FeaturedPrototypesCarousel = () => {
  ...
  const navigateToProject = () => {
    // If already on projects page, scroll directly to the project
    if (window.location.pathname === '/projects') {
      const projectElement = document.querySelector(`[data-project-id="${currentPrototype.projectId}"]`);
      if (projectElement) {
        projectElement.scrollIntoView({ behavior: 'smooth', block: 'start' });
      }
    } else {
      // Navigate to Projects page and use state to trigger scroll
      navigate('/projects', { state: { scrollToProject: currentPrototype.projectId } });
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={prevSlide}
              className="w-10 h-10 rounded-full border border-border/50 bg-background/50 hover:bg-accent transition-all duration-200 flex items-center justify-center group"
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {currentPrototype.detailedDescription}
                    </p>
                  </div>
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="mt-6 text-center space-y-4 max-w-sm">
              <h3 className="text-xl font-semibold text-foreground">
                {currentPrototype.name} – {currentPrototype.description}
              </h3>
...
export default FeaturedPrototypesCarousel;